...
<head>
   ...
   <title>Forgot Password - Document Request</title>
</head>
   ...
   <div class="login container grid">
      <div class="login__access page-animate">
         ...
         <div class="login__area">
            <form action="" class="login__form" id="forgotPasswordForm">
               ...
               <button type="submit" class="login__button">Send verification code</button>
            </form>
   
            <p class="login__switch">
               Remember your password? 
               <a href="index.php" style="color: var(--first-color); font-weight: var(--font-semi-bold);">Log in</a>
            </p>
         </div>
      </div>
   </div>
