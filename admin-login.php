...
<head>
   ...
   <title>Registrar Login - EVSU Document Request</title>
</head>
<body>
   ...
   <div class="login container grid">
      <div class="login__access">
         ...
         <h1 class="login__title">Registrar Portal</h1>
         <div class="login__area">
            ...
            <div class="login__switch" style="text-align:center;margin-top:.75rem;display:flex;flex-direction:column;gap:.4rem;">
               ...
               <a href="teller-login.php" style="color:var(--text-color-light);font-size:.8rem;">Teller? Login here</a>
            </div>
         </div>
      </div>
   </div>
         ...
         if (data.success) {
           if (data.role !== ALLOWED_ROLE) {
             Swal.fire({
               ...
               text: 'This login page is for Registrar accounts only.',
